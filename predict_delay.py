...
arr_time = add_minutes_to_time(current_time, 56)
stations = ['LIVST', 'STFD', 'SHENFLD', 'CHLMSFD', 'CLCHSTR', 'MANNGTR', 'IPSWICH', 'STWMRKT', 'DISS', 'NRCH']
starting_index = stations.index("SHENFLD")
time_between_stations = [20,10,30,15,18,19,20,10,9]
end_index = stations.index("NRCH")
time_of_journey = sum(time_between_stations[starting_index:end_index])
arr_time = add_minutes_to_time(current_time,time_of_journey+ 56)
print(arr_time)
#%%
